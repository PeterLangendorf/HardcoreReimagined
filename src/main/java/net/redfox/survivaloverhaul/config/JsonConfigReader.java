...
public class JsonConfigReader {
  ...
  public static final Runnable WEIGHTS = () -> writeJsonFile(getFilePathAsString("weight/weights"),
      createDefaultJsonObject(
          createJsonArray(new JsonObjectBuilder().add("item", "#minecraft:anvils").add("weight", 40.0).build(),
