...
public class ModCommonConfigs {
  private static final ArrayList<String> DEFAULT_DIFFICULTY_MULTIPLIER = new ArrayList<>(
      Arrays.asList("peaceful:1", "easy:2", "normal:4", "hard:8"));
  ...
  static {
    BUILDER.push("common");
    {
      ...
      {
        TEMPERATURE_FLUCTUATION = BUILDER.comment("If true, enables a small constant temperature fluctuation.")
            .define("temperature_fluctuation", true);

        BUILDER.push("biomes");
        {
          BIOME_TEMPERATURE_ENABLED = BUILDER.comment("If true, enables temperature fluctuation based on biomes.")
        ...
        BUILDER.push("insulators");
        {
          BLOCK_INSULATOR_TEMPERATURE_ENABLED = BUILDER
              ...
              .comment(
                  "Block insulators can be modified in the JSON file at /survivaloverhaul/temperature/insulators.json")
        ...
        BUILDER.push("inside_blocks");
        {
          INSIDE_BLOCK_TEMPERATURE_ENABLED = BUILDER
              ...
              .comment(
                  "Inside blocks can be modified in the JSON file at /survivaloverhaul/temperature/inside_blocks.json")
        ...
        BUILDER.push("on_top_blocks");
        {
          ON_TOP_BLOCK_TEMPERATURE_ENABLED = BUILDER
              ...
              .comment(
                  "On-top blocks can be modified in the JSON file at /survivaloverhaul/temperature/on_top_blocks.json")
        ...
        {
          WEATHER_TEMPERATURE_ENABLED = BUILDER.comment("If true, enables temperature fluctuation based on weather.")
              .define("weather_temperature_enabled", true);

          RAIN_TEMPERATURE = BUILDER.comment("The temperature that is applied when exposed to rain")
              .define("rain_temperature", -30);

          SNOW_TEMPERATURE = BUILDER.comment("The temperature that is applied when exposed to snow")
        ...
        BUILDER.push("time");
        {
          TIME_TEMPERATURE_ENABLED = BUILDER.comment("If true, enables temperature fluctuation based on time.")
              .define("time_temperature_enabled", true);

          DAY_TEMPERATURE = BUILDER.comment("The temperature that is applied when it is daytime")
              .define("day_temperature", 10);

          NIGHT_TEMPERATURE = BUILDER.comment("The temperature that is applied when it is nighttime")
        ...
        BUILDER.push("fire");
        {
          FIRE_TEMPERATURE_ENABLED = BUILDER.comment("If true, enables temperature fluctuation based on fire.")
              .define("fire_temperature_enabled", true);

          FIRE_TEMPERATURE = BUILDER.comment("The temperature that is applied when the player is on fire")
        ...
        {
          ALTITUDE_TEMPERATURE_ENABLED = BUILDER.comment("If true, enables temperature fluctuation based on altitude.")
              .define("altitude_temperature_enabled", true);

          UPPER_ALTITUDE = BUILDER.comment("The upwards y-value when temperature will start changing")
              .define("upper_altitude", 80);

          UPPER_MULTIPLIER = BUILDER.comment("The amount of blocks that result in a change of 1 temperature").comment(
          ...
          LOWER_ALTITUDE = BUILDER.comment("The downwards y-value when temperature will start changing")
              .define("lower_altitude", 40);

          LOWER_MULTIPLIER = BUILDER.comment("The amount of blocks that result in a change of 1 temperature").comment(
              "For example, a value of 5 means that every 5 blocks traveled after the start will change your temperature by 1")
        ...
        BUILDER.push("armor_insulators");
        {
          ARMOR_INSULATOR_TEMPERATURE_ENABLED = BUILDER
              ...
              .comment(
                  "Armor insulators can be modified in the JSON file at /survivaloverhaul/temperature/armor_insulators.json")
      ...
      {
        CROP_GROWTH_DIFFICULTY_MULTIPLIERS = BUILDER
        ...
        {
          BONE_MEAL_UPPER_LIMIT = BUILDER.comment(
              "The upper limit for the amount of ticks a piece of bone meal can accelerate a plant growth, depending on difficulty.")
              .defineList("boneMealUpperLimit",
                  new ArrayList<>(Arrays.asList("peaceful:5", "easy:4", "normal:2", "hard:0")),
                  obj -> obj instanceof String);
          BONE_MEAL_LOWER_LIMIT = BUILDER.comment(
              "The lower limit for the amount of ticks a piece of bone meal can accelerate a plant growth, depending on difficulty.")
              .defineList("boneMealLowerLimit",
                  new ArrayList<>(Arrays.asList("peaceful:2", "easy:1", "normal:0", "hard:0")),
                  obj -> obj instanceof String);
        }
        BUILDER.pop();
        BABY_GROWTH_MODIFIERS = BUILDER.comment("The modifier for the growth time of baby animals.")
            .defineList("babyGrowthMultiplier", DEFAULT_DIFFICULTY_MULTIPLIER, obj -> obj instanceof String);
        BREEDING_COOLDOWN_MULTIPLIERS = BUILDER.comment("The modifier for the breeding cooldown of animals.")
            .defineList("breedingCooldownMultiplier", DEFAULT_DIFFICULTY_MULTIPLIER, obj -> obj instanceof String);
        EGG_COOLDOWN = BUILDER.comment("The base cooldown for eggs being laid").define("eggCooldown", 6000);
        EGG_TIME_MODIFIERS = BUILDER.comment("The modifier for the egg laying cooldown of chickens.")
      ...
      BUILDER.push("food");
      {
        ...
        {
          BUILDER.comment(
              "Passive exhaustion is exhaustion that is applied constantly to the player, no matter what they're doing.");
          PASSIVE_EXHAUSTION_ENABLED = BUILDER.comment("If true, enables passive exhaustion")
              .define("passiveExhaustionEnabled", true);
          PASSIVE_EXHAUSTION_RATE = BUILDER
          ...
          GLOBAL_HUNGER_MULTIPLIER_ENABLED = BUILDER.comment("If true, enables the global hunger multiplier.")
              .define("globalHungerMultiplierEnabled", true);
          GLOBAL_HUNGER_MULTIPLIERS = BUILDER.comment("The multiplier, based on difficulty, that will be applied.")
        ...
        {
          FOOD_MODIFICATION_ENABLED = BUILDER.comment("If true, enables the modification of specified foods.")
        ...
        {
          FOOD_HISTORY_ENABLED = BUILDER
              .comment("If true, enables progressive decay from eating the same food repeatedly.")
              .define("foodHistoryEnabled", true);

          NUTRITION_DECAY = BUILDER.comment(
              ...
              .define("nutritionalDecay", new ArrayList<>(Arrays.asList(1.0, 1.0, 1.0, 0.75, 0.5, 0.25, 0.0)));

          MAX_HISTORY = BUILDER.comment("The maximum food history that is stored.").defineInRange("Max History", 30, 3,
              100);
        }
        BUILDER.pop();
      }
      ...
      BUILDER.push("player");
      {
        BUILDER.push("spawn");
        {
          SPAWN_MODIFIERS_ENABLED = BUILDER
              .comment("If true, the following multipliers will be applied to the player upon respawn.")
              .define("spawnModifiersEnabled", true);

          SPAWN_HEALTH_MULTIPLIER = BUILDER.comment("The multiplier applied to health upon respawn")
              .define("spawnHealthMultiplier", 0.5);
          SPAWN_HUNGER_MULTIPLIER = BUILDER.comment("The multiplier applied to hunger upon respawn")
              .define("spawnHungerMultiplier", 0.5);
        }
        BUILDER.pop();
        BUILDER.push("combat");
        {
          NO_KNOCKBACK_ENABLED = BUILDER
              .comment("If true, the player will not be able to deal knockback when below a certain amount of health")
              .define("noKnockbackEnabled", true);
          NO_KNOCKBACK_HEALTH_REQUIREMENT = BUILDER
              .comment("The amount of health at which the player will no longer be able to deal knockback")
              .define("noKnockbackHealthRequirement", 6.0d);
        }
