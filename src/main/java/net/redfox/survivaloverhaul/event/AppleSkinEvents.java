...
public class AppleSkinEvents {
  public static void appleskinDisplay(FoodValuesEvent event) {
    event.modifiedFoodValues = new FoodValues((int) (PlayerFoodHistory
        .getMultiplierAndSum(ClientFoodHistoryData.get(), PlayerFoodHistory.getItemNameFromStack(event.itemStack)).getB()
        * event.modifiedFoodValues.hunger), event.modifiedFoodValues.saturationModifier);
  }
}
